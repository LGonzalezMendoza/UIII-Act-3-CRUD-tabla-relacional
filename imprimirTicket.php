...
$sentenciaProductos = $base_de_datos->prepare("SELECT p.id_producto,p.nombreProducto ,p.precio, p.color, p.existencia, p.modelo, p.tipo_de_instrumento, p.equipamiento, p.marca,pv.cantidad
FROM productos p
INNER JOIN 
